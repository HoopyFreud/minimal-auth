/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e613c37f6a575b2eba1c8e398acf06f4)
// Runtime types generated with workerd@1.20260714.1 2026-07-18 nodejs_als
interface __BaseEnv_Env {
	UserDB: D1Database;
	BETTER_AUTH_URL: "https://min-auth.mechanist.net/";
	CLOUDFLARE_ACCOUNT_ID: string;
	CLOUDFLARE_USER_DATABASE_ID: string;
