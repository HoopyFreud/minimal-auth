...
This is because while building wrangler will throw a shitfit if it sees `event.platform.env`, presumably because it wants to figure out routing and there's nothing to route to. Frankly the Cloudflare docs leave a lot to be desired here, this is mostly conjecture on my end.
